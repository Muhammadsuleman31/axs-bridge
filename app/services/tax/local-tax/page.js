...
export default function LocalTaxPage() {
  return (
    <div className="servicescontainer">
      <main className="servicescontent">
        ...
        <p className="servicesparagraph">
          We also assist clients in navigating country-specific tax incentives, investment reliefs, and government grant opportunities, including EU and other regional programs.
        </p>
